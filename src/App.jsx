...
// ── Auto stream title — one per event ─────────────────────────
const EVENT_TITLES = {
...
// ── Contextual chat pools per event ───────────────────────────
const EVENT_CHAT = {
  // Basement grind — tiny dead chat
  0: [
    "yo",
    "hello??",
    "anyone here",
  ...
  1: [
    "parents gonna take the pc 💀",
    "bro its 3am",
    "go to sleep",
    "stream till they pull the plug",
    "W dedication",
    "they mad?",
    "turn down the mic",
  ...
  2: [
    "bro nobody is watching",
    "this aint it",
    "post on tiktok",
    "bro is determined",
    "5 viewers 💀",
    "clip something",
    "algorithm is not in ur favor rn",
    "W for trying",
  ...
  3: [
    ...
    "SPAM THE DONO",
    "this is so funny",
    "clix about to be so confused",
    "LACY IS INSANE",
    "keep going keep going",
    "he's gonna see it",
    "HELP 😭😭",
    "W behavior",
    "bro really said hold my beer",
  ],
  4: [
    "CLIX READ IT 💀",
    "NO WAY HE SAW IT",
    ...
    "I was here for this",
    "historic moment",
    "POV: ur watching history",
    "LACY LACY LACY",
    "this is ur moment bro",
    "SCREAM",
  ],
  // Side character arc
  5: [
    "people are clipping you fr",
    "TikTok found you",
    "the awkward moments compilation goes crazy",
    "bro is becoming a meme",
    "LACY IS WEIRD (affectionate)",
    "clip that clip that",
    "he's not real 😭",
    "the internet found him",
    "W side character arc",
    "YOU'RE BLOWING UP",
  ...
  // Lost kid IRL
  6: [
    "bro actually helped the kid",
    "W human being",
    "this is actually wholesome",
    "ngl this is kinda sweet",
    "LACY IS THE GOAT",
    "the parents are so happy",
    "clip going viral rn",
    "this is the moment",
    "I'm not crying you're crying",
    "different side of lacy fr",
    "W W W W",
    "wholesome arc unlocked",
  ],
  // Crashout stream
  7: [
    "LACY IS CRASHING OUT",
    "CHAT IS NOT READY",
    "bro is unhinged rn",
    ...
    "he's not okay",
    "W crashout",
    "LACY IS BUILT DIFFERENT",
    "mod where are you",
    "this stream is going down in history",
  ],
  // Dallas move
  8: [
    "DALLAS ARC",
    ...
    "CONTENT BOUTTA CHANGE",
    "new era loading...",
    "fr fr this is huge",
    "no going back now",
    "Dallas about to see Lacy different",
    "W W W",
    "the grind continues",
    "era change confirmed",
    "real ones been here since the basement",
    "LETS GOOO",
  ],
  // Darla arc
  9: [
  ...
  10: [
    "MIAMI ARC",
    "he made it",
    "bro is actually in Miami",
    "glow up confirmed",
    "IRL content goes crazy",
    "W W W W",
    "from basement to Miami 📈",
    "the come up is real",
    "Miami is not ready for Lacy",
    "era W",
    "content is gonna be insane",
    "no more mic issues hopefully",
    "LETS GOOOO",
  ],
  // Adin Ross linkup
  11: [
    "ADIN AND LACY",
    "this is the biggest stream ever",
    "the internet is watching rn",
    "HE'S ON ADIN'S STREAM",
    "don't blow it",
    "act crazy act crazy",
    "be yourself be yourself",
    "Adin's chat is going insane",
    "MASSIVE moment",
    "fr fr this is HUGE",
    "I can't believe this",
    "from 2 viewers to this 😭",
    "the grind paid off",
    "LACY ON TOP",
  ],
  // Miami IRL chaos
  12: [
    ...
    "every stream is an event fr",
    "W IRL streamer",
    "Miami loves Lacy",
    "he's different out here",
    "CLIP INCOMING",
    "something always happens on these",
    "best streamer in Miami rn",
  ],
  // Viral sports clips
  13: [
    "ONE HANDED CATCH 😭",
    "BRO IS ACTUALLY ATHLETIC",
    "this clip has 5M views??",
    "LACY IS BUILT",
    "he's an athlete now??",
    "the internet does NOT know what to do with this",
    "different breed fr",
    "W catch W catch",
    "bro is just built different",
    "this went SO viral",
    "unexpected arc but I'm here for it",
    "sports lacy > gaming lacy",
  ],
  // FaZe offer
  14: [
    "FAZE LACY",
    ...
    "THIS IS HUGE",
    "BRO WON",
    "from 2 viewers to FaZe 📈",
    "the grind arc is COMPLETE",
    "legitimacy unlocked",
    "FaZe made the right call",
    "W org W org",
    "real ones been here since day 1",
    "I was here 🫡",
    "new chapter",
  ...
  15: [
    "FAZE HOUSE CONTENT",
    "bro lives with the creators now",
    "content machine activated",
    "daily collabs fr",
    "the house is gonna be insane",
    "W move",
    "FaZe house era",
    "this is gonna go crazy",
    "who else is in the house",
    "the lifestyle content incoming",
    "era W no cap",
    "he really made it",
  ],
  // Marlon collabs
  16: [
    ...
    "these two together 😭",
    "W collab W collab",
    "this stream is trending",
    "every time they stream together it goes crazy",
    "CLIP THIS",
    "undeniable chemistry fr",
    "the internet loves these two",
    "best duo in streaming rn",
    "can't make this up",
  ],
  // Haircut stream
  17: [
  ...
  18: [
    ...
    "the org drama fr",
    "bro is about to say something big",
    "this feels serious",
  ...
  19: [
    "CORE???",
    "HIS OWN ORG",
    "BRO STARTED HIS OWN THING",
    "THIS IS HUGE",
    "CORE LACY",
    "the internet is losing it",
    "announcement dropped",
    "from FaZe to founding his own org",
    "W move W move",
    "this is the play",
    "he's built different",
    "CORE IS GONNA BE MASSIVE",
    "era defining moment",
    "we been here since the basement 🫡",
  ],
  // Good ending
  20: [
    "2.5M FOLLOWERS",
    ...
    "greatest arc in streaming",
    "W W W W W W",
    "he really did it",
    "Miami house confirmed?",
    "the grind was worth it",
    "WE WON",
    "LACY ON TOP",
    "nobody believed in him and look",
...
// Default fallback chat for bad paths / misc events
const DEFAULT_CHAT = [
  "W",
  "LMAOOOO",
  "bro said what 💀",
  ...
  "bro really said that on stream",
  "nah this is sending me",
  "W W W W",
  "no cap fr fr",
];

// OBS scene label per event
      ...
      <div ref={ref} className="flex-1 overflow-y-auto flex flex-col gap-2 min-h-0 pr-0.5">
        {clips.length === 0 && (
          <div className="flex flex-col items-center justify-center h-full gap-3 opacity-30">
            ...
            <div className="text-zinc-500 text-xs text-center leading-relaxed">
              Viral clips will<br />appear here
            </div>
          </div>
        )}
        {clips.map((clip, i) => (
          ...
          >
            ...
            {clip.link && (
              <a
                ...
                className="inline-block mt-2 text-zinc-700 hover:text-zinc-400 text-xs transition-colors"
              >
                view on tiktok →
              </a>
            )}
  ...
  return (
    <div className="fixed bottom-5 right-5 z-40 flex flex-col-reverse gap-2 pointer-events-none">
      {alerts.map(a => (
        <div
          key={a.id}
          className={`border px-4 py-2.5 rounded-xl text-xs font-bold max-w-[260px] ${STYLES[a.type] || STYLES.follow}`}
...
export default function App() {
  ...
  // ── Contextual Chat ───────────────────────────────────────────
  const USERNAMES = [
    "xXDarkSlayer99","streamer_fan22","TwitchViewer_","NRGfan","clixgang","lacyW",
    "actuallygoated","viewer1847","notabot_real","yunggrinder","w_merchant","clipchaser",
    "viralmoment","fortniteking","chatspammer","miamimade","fazeclip","coregrinder",
    "tiktokwatcher","streamsniper_","W_predictor","based_viewer","lacyismygoat","irl_enjoyer",
  ];

  const USER_COLORS = [
    "text-pink-400","text-blue-400","text-green-400","text-yellow-400",
    "text-purple-400","text-red-400","text-cyan-400","text-orange-400",
  ];
  ...
  const pushMessage = useCallback(() => {
    // Use contextual pool for current event, fall back to default
  ...
  const ENDINGS = {
    good: {
      emoji: "👑", label: "YOU MADE IT",
      color: "text-yellow-400", border: "border-yellow-800", bg: "bg-yellow-950/20",
      sub: "From 2 viewers to internet royalty. They said it wouldn't happen.",
    },
    mid: {
      emoji: "😐", label: "STUCK AT MID",
      color: "text-zinc-400", border: "border-zinc-700", bg: "bg-zinc-900/40",
      sub: "Not famous. Not forgotten. Just... mid. The algorithm had other plans.",
    },
    bad: {
      emoji: "💀", label: "STREAM OVER",
      color: "text-red-400", border: "border-red-900", bg: "bg-red-950/20",
      sub: "The grind broke you. But hey — at least you tried.",
    },
  };
    ...
    <div className="min-h-screen bg-[#0d0d10] text-white" style={{ fontFamily: "'Helvetica Neue', Arial, sans-serif" }}>
      ...
      {pendingClip && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/90 p-4">
          <div
            className="w-full max-w-sm bg-[#111114] border-2 border-red-600 rounded-3xl overflow-hidden flex flex-col shadow-2xl"
            style={{ maxHeight: "calc(100vh - 2rem)", animation: "slideUp 0.2s ease-out" }}
          >
            ...
            <div className="flex-1 min-h-0 flex justify-center px-4 pt-4 pb-2 bg-[#0a0a0c]">
              {pendingClip.embedUrl ? (
                <iframe
                  src={pendingClip.embedUrl}
                  className="rounded-xl border border-zinc-800 w-full"
                  style={{ maxWidth: 300, minHeight: 180, height: "100%" }}
                  allowFullScreen
            ...
            <div className="px-5 py-4 bg-[#111114] border-t border-zinc-800 flex-shrink-0">
              ...
              <div className="flex gap-2">
                {pendingClip.linkUrl && (
                  <a
                    href={pendingClip.linkUrl}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex-1 bg-zinc-800 hover:bg-zinc-700 text-white text-center py-3 rounded-xl font-bold text-sm transition-all"
                  >
                    📱 TikTok
                  </a>
                )}
      ...
      {/* ── Page layout ── */}
      <div className="max-w-[1400px] mx-auto px-4 pb-8 pt-4 flex flex-col gap-4">

        {/* Header */}
        <div className="flex items-end justify-between">
          <div>
            <div className="text-zinc-700 text-[10px] uppercase tracking-[0.25em] font-bold mb-1">
              Internet Streamer Simulator
            </div>
            <h1 className="text-5xl font-black text-purple-500 leading-none tracking-tight">
              StreamerLife
            </h1>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-4">
          ...
          {/* Clip Timeline */}
          <div
            className="lg:col-span-3 bg-[#111114] border border-zinc-800 rounded-2xl p-4"
            style={{ height: 510 }}
          >
          ...
          {/* Event Card */}
          <div className="lg:col-span-6 bg-[#111114] border border-zinc-800 rounded-2xl p-7 flex flex-col">

            <div className="flex items-center gap-2 flex-wrap mb-5">
              <span className="text-zinc-700 text-[10px] font-black uppercase tracking-widest border border-zinc-800 px-2.5 py-1 rounded-lg">
                {scene}
              </span>
              {streamTitle && (
                <span className="text-zinc-600 text-xs font-mono truncate max-w-[280px]">
                  "{streamTitle}"
                </span>
              )}
            </div>
            ...
            <div className="flex flex-col gap-3">
              {isEnding ? (
                (() => {
                  const cfg = ENDINGS[event.ending] || ENDINGS.good;
                  return (
                    <div className={`rounded-2xl border-2 ${cfg.border} ${cfg.bg} p-8 text-center`}>
                      <div className="text-6xl mb-4">{cfg.emoji}</div>
                      <div className={`text-3xl font-black mb-3 ${cfg.color}`}>{cfg.label}</div>
                      <div className="text-zinc-500 text-base mb-7 max-w-sm mx-auto leading-relaxed">{cfg.sub}</div>
                      <div className="flex gap-3 justify-center flex-wrap mb-7">
                        {[
                          ...
                          <div key={s.l} className="bg-zinc-900 border border-zinc-800 rounded-xl px-4 py-3">
                      ...
                      <button
                        onClick={resetGame}
                        className="bg-purple-600 hover:bg-purple-500 active:scale-95 px-8 py-3.5 rounded-xl font-black text-base transition-all"
                      >
                        🔄 Play Again
                      </button>
                    </div>
                ...
                event?.choices.map((choice, i) => (
                  ...
                  >
                    <div className="flex items-center justify-between gap-4">
                      ...
                      {choice.viralClip && (
                        <span className="text-red-500 text-xs font-black flex-shrink-0 opacity-60 group-hover:opacity-100 transition-opacity">
                          📼 CLIP
                        </span>
                      )}
                    </div>
          ...
          {/* Live Chat */}
          <div
            className="lg:col-span-3 bg-[#111114] border border-zinc-800 rounded-2xl flex flex-col overflow-hidden"
            style={{ height: 510 }}
          >
            ...
            >
              ...
              {liveChat.map(msg => (
                <div
                  key={msg.id}
                  className="bg-zinc-900/80 rounded-lg px-3 py-1.5 text-xs leading-snug"
